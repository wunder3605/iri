...
public class PearlDiver {
    ...
    private ThreadPoolExecutor  threadPoolExecutor = new ThreadPoolExecutor(10, 500, 3, TimeUnit.SECONDS, new ArrayBlockingQueue(2));
    ...
    public synchronized boolean search(final byte[] transactionTrits, final int minWeightMagnitude,
        ...
        while (numberOfThreads-- > 0) {
            ...
            workers.add(threadPoolExecutor.submit(worker));
        }
